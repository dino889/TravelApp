...
## VERSION Information
- Android Version SDK 26.0 이상 사용가능
- 날씨정보 API 위치권한 허용 사용가능
- 미세먼지 정보 API 위치권한 허용 사용가능
- 캠핑장 정보 API 위치권한 허용 사용가능
...
- 최근검색 : 앱종료시 저장안됨
- Naver Login : 네이버 로그인 검수 진행이 불가능하여 미리 등록된 아이디만 기능 테스트 가능
...
## 추가 필요한 정보
https://www.notion.so/Travel-App-594f767375c1449587451c839a7016e4
