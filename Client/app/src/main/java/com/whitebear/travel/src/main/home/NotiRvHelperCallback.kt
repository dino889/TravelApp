...
class NotiRvHelperCallback(private val recyclerViewAdapter: NotificationAdapter) : ItemTouchHelper.Callback() {
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View = viewHolder.itemView.findViewById(R.id.swipe_layout_noti)
